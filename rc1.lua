...
awful.screen.connect_for_each_screen(function(s)
      ...
      awful.tag({ "1", "2", "3", "4", "5", "6", "7", "8", "9", "a", "b", "c", "d", "e", "f", "g" }, s, awful.layout.layouts[2])
...
globalkeys = gears.table.join(
   ...
   awful.key({                   }, "Print", function() awful.util.spawn("shutter -f") end,
      {description = "Fullscreen Screenshow", group = "client"}),

   awful.key({ modkey            }, "Print", function() awful.util.spawn("shutter -s") end,
      {description = "Selected Area Screenshow", group = "client"}),
   ...
   awful.key({ modkey, }, "#167", function () awful.screen.focus(1) end,
      {description = "focus right screen", group = "screen"}),
   awful.key({ modkey, }, "#166", function () awful.screen.focus(2) end,
   ...
   awful.key({}, "#192", function ()
      ...
      awful.spawn.single_instance("subl", {
         focus = true,
         tag = tag,
      })
   ...
   awful.key({}, "#193", function ()
      ...
      local screen = awful.screen.focused()
      local tag = screen.tags[1]
      awful.spawn("/home/vlads/Downloads/Telegram/Telegram")
   end),
   awful.key({}, "#194", function () awful.spawn("i3lock -c 000000") end),
   awful.key({}, "#194", function () end),
